...
| Cómo se organiza la cartelera que ve el cliente | Una tarjeta por función (lista corrida), todas las películas con sus siete días a la vista, o **un día a la vez** elegido por el cliente | **Un día a la vez**: una lista desplegable con los días de la semana y, debajo, una tarjeta por sala con su película, su afiche y los horarios de ese día | Una semana tiene entre 42 y 56 funciones (`ESPECIFICACION.md`, glosario "Cartelera"): mostrarlas todas de una vez es ilegible en cualquier forma que se pruebe. Con el día elegido, la pantalla queda en dos tarjetas —una por sala— que es exactamente lo que el cine ofrece ese día (RN-15). Encabezar por sala, y no por película, deja a la vista cuál es la sala grande y cuál la chica, dato que el cliente necesita antes de elegir asiento. |
...
| Cómo funciona el desplegable de días sin JavaScript | Recargar la página con un botón, o que la lista navegue sola con un poco de JavaScript | Un formulario con la lista desplegable y un botón "Ver". Sin nada de JavaScript | Mantiene la decisión de "pantallas en HTML simple, sin herramientas de compilación": el día elegido viaja en la dirección de la página (`/?dia=...`), así que la pantalla se puede compartir por enlace y funciona igual con el navegador más viejo. El costo es un clic más. |
...
| Cómo se muestra cada horario | Como un botón con recuadro vs. como texto suelto | Solo la hora, en texto, sin recuadro; al lado, una etiqueta chica que dice si es doblada o subtitulada | Con tres o cuatro horarios por sala, un recuadro por cada uno llena la pantalla de cajas y compite con el afiche, que es lo que el cliente mira primero. La hora sola se lee igual de rápido y ocupa una fracción del espacio. La etiqueta de formato va más chica que la hora porque es un dato de apoyo, no lo que se elige. |
